...
impl<'d, PIO: Instance, const SM: usize> Ssi<'d, PIO, SM, Async> {
    ...
    async fn transfer_inner(
        ...
        let rx_transfer = async {
            rx.dma_pull(&mut rx_ch, unsafe { &mut *rx_buffer }, false)
                .await;
...
// impl<'d, PIO: Instance, const SM: usize, M: Mode> embedded_hal_02::blocking::spi::Transfer<u8>
//     for Spi<'d, PIO, SM, M>
// {
//     type Error = Error;
...
// impl<'d, PIO: Instance, const SM: usize, M: Mode> embedded_hal_02::blocking::spi::Write<u8>
//     for Spi<'d, PIO, SM, M>
// {
//     type Error = Error;
...
// impl<'d, PIO: Instance, const SM: usize, M: Mode> embedded_hal_1::spi::ErrorType
//     for Spi<'d, PIO, SM, M>
// {
//     type Error = Error;
// }

// impl<'d, PIO: Instance, const SM: usize, M: Mode> embedded_hal_1::spi::SpiBus<u8>
//     for Spi<'d, PIO, SM, M>
// {
...
// impl<'d, PIO: Instance, const SM: usize> embedded_hal_async::spi::SpiBus<u8>
//     for Spi<'d, PIO, SM, Async>
// {
