...
use tracing_subscriber::{EnvFilter, prelude::*, registry::Registry};
...
pub fn init_logs() {
    ...
    let file_layer = tracing_subscriber::fmt::Layer::new()
        ...
        .with_filter(tracing_subscriber::filter::EnvFilter::new(
            "info,robotarm=trace,eframe=warn,wgpu=warn",
        ));
    ...
    let stderr_layer = tracing_subscriber::fmt::layer()
        ...
        .compact()
        .with_filter(tracing_subscriber::filter::EnvFilter::new(
            // "info,robotarm=debug,eframe=warn,wgpu=warn",
            "warn,robotarm=debug,eframe=warn,wgpu=warn",
        ));
